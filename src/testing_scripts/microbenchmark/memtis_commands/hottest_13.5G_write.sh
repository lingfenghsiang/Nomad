...
function func_main() {
    ...
    # make directory for run-memtis-13.5g-write/results-pr
    mkdir -p ${DIR}/microbench_memtis/run-memtis-13.5g-write/microbench/
    LOG_DIR=${DIR}/microbench_memtis/run-memtis-13.5g-write/microbench/
